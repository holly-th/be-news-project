...
describe("GET/api/users", () => {
  test("200: returns an array with the correct number of user objects in it", () => {
    return request(app)
      .get("/api/users")
      .expect(200)
      .then(({ body }) => {
  ...
  test("200: returns an array of user objects with all the correct properties inside", () => {
    return request(app)
      .get("/api/users")
      .expect(200)
      .then(({ body }) => {
